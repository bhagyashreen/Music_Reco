		...
		<div id="header">
			<div>
				...
				<ul class="navigation">
					...
					<li>
						<a href="HomePage.html"><font color = "#8A0808"FONT FACE="algerian">Logout</font></a>
					</li>
			...
			<div id="loginOptions" style="margin: 40px 0px 0px 50px;">
				...
				<div class="span5" style="margin-right: -10px;">
					<div
						...
						<h3>Insert card details</h3>
						<table>
							<tr>
							<td><label for="inputPassword3" class="col-sm-2 control-label">Card number</label></td>
								<td><div class="col-sm-10"> <input type="number" class="form-control" id="number"
											placeholder="number"">
									</div></td>
							</tr>
							...
							<tr>
								...
								<td><div class="col-sm-offset-2 col-sm-10">
										<button type="submit" class="btn btn-primary" style= "margin-left:45px" id="login"  onclick="validateCreditCard();">Validate</button>
									</div></td>
							</tr>
						</table>
					</div>
